...
from ..datas import humaneva_valid_angle_check_cuda
...
def loss_valid_angle_t1(pred, valid_ang, data="humaneva"):
    '''
...
def loss_valid_angle_t2(pred, valid_ang, data="humaneva"):
    '''
...
def compute_angle_error(pred, valid_ang, data="humaneva"):
    '''
    pred: n, 48, 100
